...
%t = (X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)
%vy = X(:,1).*sind(X(:,2))
%vx = X(:,1).*cosd(X(:,2))
fun = @(p,X)((1-p(3)*((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1))+p(3)^2.*(((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)).^2)/2).*(- (X(:,1).*cosd(X(:,2)))*p(3)^2 + p(4)*(X(:,1).*sind(X(:,2)))*p(3) + p(1)*p(4)))/p(3)^3 - (- (X(:,1).*cosd(X(:,2)))*p(3)^2 + p(4)*(X(:,1).*sind(X(:,2)))*p(3) + p(1)*p(4))/p(3)^3 + (((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)).*(p(1)*p(4) + p(3)*p(4)*(X(:,1).*sind(X(:,2)))))/p(3)^2 - (g*p(4)*((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)).^2)/(2*p(3));
%
fun = @(p,X)(exp(-p(3)*((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1))).*(- (X(:,1).*cosd(X(:,2)))*p(3)^2 + p(4)*(X(:,1).*sind(X(:,2)))*p(3) + p(1)*p(4)))/p(3)^3 - (- (X(:,1).*cosd(X(:,2)))*p(3)^2 + p(4)*(X(:,1).*sind(X(:,2)))*p(3) + p(1)*p(4))/p(3)^3 + (((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)).*(p(1)*p(4) + p(3)*p(4)*(X(:,1).*sind(X(:,2)))))/p(3)^2 - (g*p(4)*((X(:,1).*sind(X(:,2)) + ((X(:,1).*sind(X(:,2))).^2+2*p(1)*p(2)).^0.5)/p(1)).^2)/(2*p(3));

p0 = [9.81,2.4,0.0048,0.0048];
